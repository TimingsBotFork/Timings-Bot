        ...
        for word in words:
            ...
            if word.startswith("https://www.spigotmc.org/go/timings?url=") or word.startswith(
                ...
                embed_var.add_field(name="❌ Spigot",
                                    value="Spigot timings have limited information. Switch to [Paper](https://papermc.io/) for better timings analysis. All your plugins will be compatible, and if you don't like it, you can easily switch back.")
                embed_var.url = word
