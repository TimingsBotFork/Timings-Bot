...
class Timings(commands.Cog):
    ...
    async def analyze_timings(self, message):
        ...
        embed_var.set_footer(text=f"Please note that these options are renerally going for the minimum. 
        Adjust them to match your server {message.author.name}#{message.author.discriminator}.", icon_url=message.author.avatar_url)
